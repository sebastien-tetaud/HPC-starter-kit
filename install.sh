...
echo -e "     ${YELLOW}python benchmark/main.py${NC}"
echo -e "     ${YELLOW}python benchmark/data_parallel.py${NC}"
echo ""
echo -e "  3. Submit HPC jobs:"
echo -e "     ${YELLOW}qsub HEALPix_BigEarthNet_gpu.pbs${NC}"
echo -e "     ${YELLOW}qsub HEALPix_BigEarthNet_cpu.pbs${NC}"
echo ""
